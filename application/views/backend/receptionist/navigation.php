        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
                    ...
                    <span class="fa arrow"></span></span>
                        ...
                        <ul class="nav nav-second-level">
                            <li><a href="<?php echo base_url();?>receptionist/manage_profile"><i class="ti-user"></i> My Profile</a></li>
                    ...
                    <li class="<?php if($page_name == 'dashboard') echo 'active';?>"> 
                        <a href="<?php echo base_url();?>receptionist/dashboard" class="waves-effect">
                ...
                <li> 
                    ...
                    <ul class="nav nav-second-level"<?php if($page_name == 'add_schedule' || $page_name == 'list_schedule') echo 'active';?>>
                            ...
                            <li class="<?php if($page_name == 'add_schedule') echo 'active';?>"> 
                                <a href="<?php echo base_url();?>receptionist/add_schedule">
                                    <i class="fa fa-angle-double-right p-r-10"></i>
                ...
                <li> 
                    ...
                    <ul class="nav nav-second-level"<?php if($page_name == 'notification') echo 'active';?>>
                            ...
                            <li class="<?php if($page_name == 'notification') echo 'active';?>"> 
                                <a href="<?php echo base_url();?>receptionist/notification">
                                    <i class="fa fa-angle-double-right p-r-10"></i>
                ...
                <li class="<?php if($page_name == 'change_profile') echo 'active';?>"> 
                    <a href="<?php echo base_url();?>receptionist/change_profile" class="waves-effect">
