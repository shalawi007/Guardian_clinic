		...
		<div class="panel panel-info">
			<div class="panel-heading"> <?php echo get_phrase('add_shedule');?>
				...
				<div class="panel-body">
					...
					<?php echo form_open(base_url() . 'receptionist/add_schedule/update/'. $shedule['shedule_id'] , 
                             ...
                             <label class="col-sm-12"><?php echo get_phrase('department');?>*</label>
                                 <div class="col-sm-12">
									<select class="select2 form-control" name="department_id" onchange="return get_department_doctors(this.value)" required>
										...
										?>
                                    		<option value="<?php echo $row['department_id'];?>"<?php if($shedule['department_id'] == $row['department_id']) echo 'selected="selected"';?>><?php echo $row['name'];?></option>
									 <?php endforeach;?>
                                    </select>
								</div>
						</div>
