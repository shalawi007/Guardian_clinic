 								...
 								<table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                    ...
                                    <?php $get_all_appointments = $this->appointment_model->select_all_appointment();
                                        ...
                                        <tr>
                                            ...
                                            <td>
												<a href="#" onclick="confirm_modal('<?php echo base_url();?>nurse/add_appointment/delete/<?php echo $appointment['appointment_id'];?>');">
												<button type="button" class="btn btn-danger btn-circle btn-xs"><i class="fa fa-times"></i> </button>
												</a>

                             					<a href="<?php echo base_url();?>nurse/edit_appointment/<?php echo $appointment['appointment_id'];?>">
