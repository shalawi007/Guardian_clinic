<div class="row">
	<div class="col-sm-12">
		<div class="panel panel-info panel-body ">
			<?php echo get_phrase("Print Prescription");?>
							
					<a href="<?php echo base_url();?>prescription/list_prescription" 
                     class="btn btn-defualt btn-xs"><i class="fa fa-mail-reply-all"></i>&nbsp;<?php echo get_phrase('back');?>
                    </a>
					
				
					
					<button type="button" name="b_print" class="btn btn-xs btn-default pull-right" onClick="printdiv('div_print');"><i class="fa fa-print"></i>
