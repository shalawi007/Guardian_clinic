                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="white-box bg-danger">
                            <div class="r-icon-stats">
                                ...
                                <div class="bodystate">
                                    <h4 style="color:white"><?php echo $this->db->get('med_category')->num_rows();?></h4>
                                    <span class="text-muted"><a href="" style="color:white"><?php echo get_phrase('Med Category');?></a></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="white-box bg-success">
                            <div class="r-icon-stats">
                                ...
                                <h4 style="color:white"><?php echo $this->db->get('medicine')->num_rows();?></h4>
                                    <span class="text-muted"><a href="" style="color:white"><?php echo get_phrase('Total Medicine');?></a></span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="white-box bg-info">
                            <div class="r-icon-stats">
                                ...
                                <div class="bodystate">
                                    ...
                                    echo $this->db->get('phamarcist')->num_rows();?></h4>
                                    <span class="text-muted"><a href="" style="color:white"><?php echo get_phrase('New Phamarcist');?></a></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="white-box bg-purple">
                            <div class="r-icon-stats">
                                ...
                                echo $this->db->get('doctor')->num_rows();?></h4>
