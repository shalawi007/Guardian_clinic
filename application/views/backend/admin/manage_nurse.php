<div class="row">
    <div class="col-sm-12">
        <div class="panel panel-info">
            <div class="panel-heading"><?php echo get_phrase('new_nurse');?>
                <div class="pull-right"><a href="#" data-perform="panel-collapse"><i class="fa fa-plus"></i>&nbsp;&nbsp;ADD NEW nurse HERE<i class="btn btn-info btn-xs"></i></a> <a href="#" data-perform="panel-dismiss"></a> </div></div>
                    <div class="panel-wrapper collapse out panel-body" aria-expanded="true">          
					    
                        <?php echo form_open(base_url() . 'admin/manage_nurse/create/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
...
<div class="row">
    <div class="col-sm-12">
		<div class="panel panel-info">
            <div class="panel-heading"> <i class="fa fa-list"></i>&nbsp;&nbsp;<?php echo get_phrase('list_nurses');?></div>
                <div class="panel-body table-responsive">
                    <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                        ...
                        <tbody>
                <?php $get_all_nurses_from_nurse_model = $this->nurse_model->select_all_nurses();
                            foreach ($get_all_nurses_from_nurse_model as $key => $selected_nurses):?>
                            <tr>
                                <td><img src="<?php echo $this->crud_model->get_image_url('nurse', $selected_nurses['nurse_id']);?>" class="img-circle" width="30px"></td>
                                <td><?php echo $selected_nurses['name'];?></td>
                                <td><?php echo $selected_nurses['email'];?></td>
                                <td><?php echo $selected_nurses['phone'];?></td>
                                <td><?php echo $selected_nurses['gender'];?></td>
                                <td><?php echo $selected_nurses['qualification'];?></td>
                                <td><?php echo $this->crud_model->get_type_name_by_id('department', $selected_nurses['department_id']);?></td>

                                <td>
                                <a onclick="showAjaxModal('<?php echo base_url();?>modal/popup/edit_nurse/<?php echo $selected_nurses['nurse_id'];?>')" class="btn btn-info btn-circle btn-xs"><i class="fa fa-edit"></i></a>
                                <a href="<?php echo base_url();?>admin/manage_nurse/delete/<?php echo $selected_nurses['nurse_id'];?>" onclick="return confirm('Are you sure want to delete?');" class="btn btn-danger btn-circle btn-xs" style="color:white"><i class="fa fa-times"></i></a>
                                <a href="<?php echo base_url() . 'uploads/nurse_image/'. $selected_nurses['file_name'];?>"  class="btn btn-success btn-circle btn-xs" style="color:white"><i class="fa fa-download"></i></a>
                                <a href="<?php echo base_url() . 'admin/completeNurseProfile/' .  $selected_nurses['nurse_id'];?>"  class="btn btn-primary btn-circle btn-xs" style="color:white"><i class="fa fa-link"></i></a>
                                </td>							
                            </tr>
                            <?php endforeach;?>
                        </tbody>
