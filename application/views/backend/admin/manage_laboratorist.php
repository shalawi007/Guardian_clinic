<div class="row">
    <div class="col-sm-12">
        <div class="panel panel-info">
            <div class="panel-heading"><?php echo get_phrase('new_laboratorist');?>
                <div class="pull-right"><a href="#" data-perform="panel-collapse"><i class="fa fa-plus"></i>&nbsp;&nbsp;ADD NEW laboratorist HERE<i class="btn btn-info btn-xs"></i></a> <a href="#" data-perform="panel-dismiss"></a> </div></div>
                    <div class="panel-wrapper collapse out panel-body" aria-expanded="true">          
					    
                        <?php echo form_open(base_url() . 'admin/manage_laboratorist/create/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
...
<div class="row">
    <div class="col-sm-12">
		<div class="panel panel-info">
            <div class="panel-heading"> <i class="fa fa-list"></i>&nbsp;&nbsp;<?php echo get_phrase('list_laboratorists');?></div>
                <div class="panel-body table-responsive">
                    <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                        ...
                        <tbody>
                <?php $get_all_laboratorists_from_laboratorist_model = $this->laboratorist_model->select_all_laboratorists();
                            foreach ($get_all_laboratorists_from_laboratorist_model as $key => $selected_laboratorists):?>
                            <tr>
                                <td><img src="<?php echo $this->crud_model->get_image_url('laboratorist', $selected_laboratorists['laboratorist_id']);?>" class="img-circle" width="30px"></td>
                                <td><?php echo $selected_laboratorists['name'];?></td>
                                <td><?php echo $selected_laboratorists['email'];?></td>
                                <td><?php echo $selected_laboratorists['phone'];?></td>
                                <td><?php echo $selected_laboratorists['gender'];?></td>
                                <td><?php echo $selected_laboratorists['qualification'];?></td>

                                <td>
                                <a onclick="showAjaxModal('<?php echo base_url();?>modal/popup/edit_laboratorist/<?php echo $selected_laboratorists['laboratorist_id'];?>')" class="btn btn-info btn-circle btn-xs"><i class="fa fa-edit"></i></a>
                                <a href="<?php echo base_url();?>admin/manage_laboratorist/delete/<?php echo $selected_laboratorists['laboratorist_id'];?>" onclick="return confirm('Are you sure want to delete?');" class="btn btn-danger btn-circle btn-xs" style="color:white"><i class="fa fa-times"></i></a>
                                <a href="<?php echo base_url() . 'uploads/laboratorist_image/'. $selected_laboratorists['file_name'];?>"  class="btn btn-success btn-circle btn-xs" style="color:white"><i class="fa fa-download"></i></a>
                                <a href="<?php echo base_url() . 'admin/completeLaboratoristProfile/' .  $selected_laboratorists['laboratorist_id'];?>"  class="btn btn-primary btn-circle btn-xs" style="color:white"><i class="fa fa-link"></i></a>
                                </td>							
                            </tr>
                            <?php endforeach;?>
                        </tbody>
