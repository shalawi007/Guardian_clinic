<div class="row">
    <div class="col-sm-12">
        <div class="panel panel-info">
            <div class="panel-heading"><?php echo get_phrase('new_receptionist');?>
                <div class="pull-right"><a href="#" data-perform="panel-collapse"><i class="fa fa-plus"></i>&nbsp;&nbsp;ADD NEW receptionist HERE<i class="btn btn-info btn-xs"></i></a> <a href="#" data-perform="panel-dismiss"></a> </div></div>
                    <div class="panel-wrapper collapse out panel-body" aria-expanded="true">          
					    
                        <?php echo form_open(base_url() . 'admin/manage_receptionist/create/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
...
<div class="row">
    <div class="col-sm-12">
		<div class="panel panel-info">
            <div class="panel-heading"> <i class="fa fa-list"></i>&nbsp;&nbsp;<?php echo get_phrase('list_receptionists');?></div>
                <div class="panel-body table-responsive">
                    <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                        ...
                        <tbody>
                <?php $get_all_receptionists_from_receptionist_model = $this->receptionist_model->select_all_receptionists();
                            foreach ($get_all_receptionists_from_receptionist_model as $key => $selected_receptionists):?>
                            <tr>
                                <td><img src="<?php echo $this->crud_model->get_image_url('receptionist', $selected_receptionists['receptionist_id']);?>" class="img-circle" width="30px"></td>
                                <td><?php echo $selected_receptionists['name'];?></td>
                                <td><?php echo $selected_receptionists['email'];?></td>
                                <td><?php echo $selected_receptionists['phone'];?></td>
                                <td><?php echo $selected_receptionists['gender'];?></td>
                                <td><?php echo $selected_receptionists['qualification'];?></td>

                                <td>
                                <a onclick="showAjaxModal('<?php echo base_url();?>modal/popup/edit_receptionist/<?php echo $selected_receptionists['receptionist_id'];?>')" class="btn btn-info btn-circle btn-xs"><i class="fa fa-edit"></i></a>
                                <a href="<?php echo base_url();?>admin/manage_receptionist/delete/<?php echo $selected_receptionists['receptionist_id'];?>" onclick="return confirm('Are you sure want to delete?');" class="btn btn-danger btn-circle btn-xs" style="color:white"><i class="fa fa-times"></i></a>
                                <a href="<?php echo base_url() . 'uploads/receptionist_image/'. $selected_receptionists['file_name'];?>"  class="btn btn-success btn-circle btn-xs" style="color:white"><i class="fa fa-download"></i></a>
                                <a href="<?php echo base_url() . 'admin/completeReceptionistProfile/' .  $selected_receptionists['receptionist_id'];?>"  class="btn btn-primary btn-circle btn-xs" style="color:white"><i class="fa fa-link"></i></a>
                                </td>							
                            </tr>
                            <?php endforeach;?>
                        </tbody>
