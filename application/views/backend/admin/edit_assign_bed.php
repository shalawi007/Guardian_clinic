                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
							<label class="col-md-12" for="example-text"><?php echo get_phrase('Assign Date');?>*</span></label>
								<div class="col-md-12">
									<input class="form-control " name="assign_date" type="date" value="<?php echo date('d M Y', $assign_bed['assign_date']);?>" id="example-date-input" required>
								</div>
						</div>
                        ...
                        <div class="form-group">
							<label class="col-md-12" for="example-text"><?php echo get_phrase('Discharge Date');?>*</span></label>
								<div class="col-md-12">
									<input class="form-control " name="discharge_date" type="date" value="<?php echo date('d M Y', $assign_bed['discharge_date']);?>" id="example-date-input" required>
								</div>
						</div>
