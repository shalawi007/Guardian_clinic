<div class="row">
	<div class="col-sm-12">
		<div class="panel panel-info">
			<div class="panel-heading"> <?php echo get_phrase("receptionist's_profile");?>
							
				<a href="<?php echo base_url();?>admin/manage_receptionist" class="btn btn-orange btn-xs"><i class="fa fa-plus"></i>&nbsp;<?php echo get_phrase('add_receptionist');?></a>
				...
				<?php echo get_phrase('print');?></button></div>
					<div class="panel-body table-responsive" id="div_print">
						...
						<?php foreach($receptionist_profile as $row):?>			
			...
			<hr>
				  ...
				  <tr>
						...
						<img src="<?php echo $this->crud_model->get_image_url('receptionist', $row['receptionist_id']);?>" alt="user" class="img-thumbnail img-responsive" 
				  ...
				  <tr>
					<td colspan="3"><div class="alert alert-info">receptionist ACCOUNTINFORMATION</div></td>
				  </tr>
				  <tr>
				 ...
				 <button class="btn btn-sm btn-outline btn-rounded btn-info" type="button" data-toggle="collapse" data-target="#collapseExample1" aria-expanded="false" aria-controls="collapseExample"><?php echo get_phrase ('get_password');?></button>
				  ...
				  <tr>
					<td colspan="3"><div class="alert alert-info">DOWNLOAD FULL DOCUMENTS ABOUT RECEPTIONIST 
					</div>&nbsp;&nbsp;Download Full Document:&nbsp;<a href="<?php echo base_url().'uploads/receptionist_image/'.$row['file_name']; ?>">
